...
def is_positive(output):
    ...
    response = client.chat.completions.create(
        model="gpt-4",
        messages=[
            {"role": "system", "content": "You are a sentiment analysis assistant. Respond only with 'positive', 'neutral', or 'negative'."},
    ...
    explanation_response = client.chat.completions.create(
        model="gpt-4",
        messages=[
            {"role": "system", "content": "You are a sentiment analysis assistant. Explain your classification briefly."},
            {"role": "user", "content": prompt},
