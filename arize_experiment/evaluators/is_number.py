...
def is_number(output):
    ...
    Returns:
        tuple: (score, label, explanation)
            ...
            - explanation (str): Description of why the value was classified as numeric or
              non-numeric
    """
    ...
    if not str_output:
        return (1, "non-numeric", "Input cannot be converted to a numeric value")

    try:
        # Attempt to convert to numeric using pandas
        pd.to_numeric(str_output, errors="raise")
